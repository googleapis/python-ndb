...
def transactional(**options):
    ...
    def transactional_wrapper(wrapped):
        ...
        def transactional_inner_wrapper(*args, **kwargs):
            ...
            return _transaction.transaction(callback, **options)
...
def transactional_async(**options):
    """A decorator to run a function automatically in an asynchronous
       transaction.
    ...
    def transactional_async_wrapper(wrapped):
        ...
        def transactional_async_inner_wrapper(*args, **kwargs):
            ...
            return _transaction.transaction_async(callback, **options)
...
def transactional_tasklet(**options):
    """A decorator that turns a function into a tasklet and runs it
       automatically in an asynchronous transaction.
...
def non_transactional(allow_existing=True):
    ...
    def non_transactional_wrapper(wrapped):
        ...
        def non_transactional_inner_wrapper(*args, **kwargs):
            ...
            new_ctx = context.Context(ctx.client)
            with new_ctx.use():
                return wrapped(*args, **kwargs)
